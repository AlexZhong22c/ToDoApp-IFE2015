        ...
        var taskTable = [
            {
                ...
                name: "使用说明",
                date: "2017-01-20",
                content: "本应用为离线应用，数据将存储在本地硬盘<br><br>左侧为分类列表<br>中间为当前分类下的任务列表<br>右侧为任务详情<br><br>可以添加删除分类，添加任务，修改任务，以及给任务标记是否完成等功能<br><br>by <a target='_blank' href='https://alexzhong22c.github.io/'>az22c</a> 2017年2月"
            },
            {
                id: 1,
                pid: 0,
